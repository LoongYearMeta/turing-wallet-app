...
export const createCollectionResponse = async (
...
export const createNFTResponse = async (
	collection_id: string,
...
export const transferNFTResponse = async (
	contract_id: string,
	address_to: string,
...
export const mintFTResponse = async (ft_data: FTData, password: string) => {
	try {
...
export const transferFTResponse = async (
	contract_id: string,
	address_to: string,
	amount: number,
	password: string,
...
export const mintPoolNFTResponse = async (
	contractId: string,
	with_lock: boolean,
	poolNFT_version: number,
	serviceFeeRate: number,
...
export const initPoolNFTResponse = async (
	contractId: string,
	address_to: string,
	tbc_amount: number,
	ft_amount: number,
	...
	try {
		...
		const ftUtxo = await getFTUtxoByContractId(address_from, ft_amount, poolUse.ft_a_contractTxid);
		if (!ftUtxo) {
			await mergeFT(poolUse.ft_a_contractTxid, address_from, password);
		}

		const txHex = await poolUse.initPoolNFT(privateKey, address_to, utxo, tbc_amount, ft_amount);
...
export const increaseLPResponse = async (
	contractId: string,
	address_to: string,
	tbc_amount: number,
	poolNFT_version: number,
...
export const consumeLPResponse = async (
	contractId: string,
	address_to: string,
	ft_amount: number,
	poolNFT_version: number,
...
export const swapToTokenResponse = async (
	contractId: string,
	address_to: string,
	tbc_amount: number,
	poolNFT_version: number,
...
export const swapToTbcResponse = async (
...
export const poolNFTMergeResponse = async (
	poolNft_contractId: string,
	merge_times: number,
	poolNFT_version: number,
	password: string,
...
export const mergeFTLPResponse = async (
	poolNft_contractId: string,
	poolNFT_version: number,
	password: string,
) => {
...
const getFTUtxoByContractId = async (
	address_from: string,
	ft_amount: number | BigInt,
	contract_id: string,
) => {
	try {
