...
import { formatBalance_tbc, formatLongString, formatDate } from '@/lib/util';
...
export const TransactionHistoryCard = ({ history }: TransactionHistoryCardProps) => {
            ...
            <View style={styles.content}>
                <View style={styles.row}>
                    ...
                    <Text
                        style={[
                            styles.value,
                            history.balance_change > 0 ? styles.positive : styles.negative,
                        ]}
                    >
                        {history.balance_change > 0 ? '+' : ''}
                        {formatBalance_tbc(history.balance_change)}
                    </Text>
                </View>
                <View style={styles.row}>
